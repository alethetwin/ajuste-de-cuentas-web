...
<template>
    ...
    <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <div class="w-full bg-surface-0 dark:bg-surface-800 py-20 px-8 sm:px-20 rounded-[56px] border-primary border-solid border-4">
                <div class="text-center mb-8">
                    ...
                    <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Bienvenido a Ajuste de Cuentas!</div>
                    <span class="text-muted-color font-medium">Inicia sesión para continuar</span>
                </div>
                <div>
                    <Message v-if="errorMessage" severity="error" text="Usuario: admin | Contraseña: admin" class="mb-4">{{ errorMessage }}</Message>
                    <!--  -->
                </div>
